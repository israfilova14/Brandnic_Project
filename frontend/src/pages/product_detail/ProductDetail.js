...
import CategoryWiseProductDisplay from '../category_wise_product_display/CategoryWiseProductDisplay';
  ...
  return (
    <div className='productDetailWrapper'>
         ...
         <div>
              ...
              {
                data?.category && (
                  <CategoryWiseProductDisplay category={data?.category} heading={"Recomended Product's"}/>
                )
              }
              </div>
         </div>
